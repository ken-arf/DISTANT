...
def train(parameters, name_suffix):
    ...
    model = RoSTER(parameters, logger)
    ...
    for epoch in range(num_train_epochs):
        ...
        torch.save(unwrapped_model.state_dict(), os.path.join(OUTPUT_PATH, f"model_last_{name_suffix}_{count}.pth"))

        if best_update:
            torch.save(unwrapped_model.state_dict(), os.path.join(OUTPUT_PATH, f"model_best_{name_suffix}_{count}.pth"))
