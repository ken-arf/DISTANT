...
from pu_dataloader_weight import PU_Dataloader
from pu_model_weight import PU_Model
...
def finetune(df_train_pos, parameters, model_name_suffix):
    ...
    if parameters['restore_model'] == True:
        ...
        if parameters['cnt'] == 1:
            ...
            model_path = parameters['restore_model_base_path'].replace(
                "%suffix%", model_name_suffix)
        else:
            model_path = parameters['restore_model_prev_path'].replace(
                "%suffix%", model_name_suffix)
